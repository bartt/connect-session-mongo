...
* reapInterval - Time to wait (ms) before removing aged session documents (default 10min)
* reapAge - Age (ms) at which session documents become subject to reaping (default 8hr)
